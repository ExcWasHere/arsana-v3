        ...
        <div className="space-y-6 text-center">
          ...
          <h1 className="text-4xl font-bold text-gray-900 leading-tight">
            ...
            <span className="text-cyan-500">
              Arsana Siap Temenin Kamu
            </span>
          </h1>

          <p className="text-lg text-gray-600 leading-relaxed italic">
            Arsana adalah platform pembelajaran digital inklusif yang dirancang
          ...
          <div className="flex items-end justify-between gap-10 mb-32">
            ...
            <div className="w-1/3 pb-2">
              <p className="text-lg text-gray-600 leading-relaxed border-l-4 border-cyan-200 pl-6">
                Arsana adalah platform pembelajaran digital inklusif yang
            ...
            <div className="space-y-12">
              <div>
                <h2 className="text-4xl font-bold text-gray-900 mb-4">
                  Mengapa harus pilih{" "}
                  <span className="text-cyan-500">Arsana</span>?
                </h2>
